...
public class RegistrationForm {
	...
	public void incorrectUsernameTest() {
		...
		driver.findElement(By.name("customerName")).sendKeys("vignesh");
		sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"ap_customer_name\"]"));
		sleep(1000);
		driver.findElement(By.name("email")).sendKeys("9344420714");
		sleep(1000);
		driver.findElement(By.name("secondaryLoginClaim")).sendKeys("vickychella31@gmail.com");
		sleep(1000);
		driver.findElement(By.name("password")).sendKeys("Ravi312k1@");
		sleep(1000);
